            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5><a href="${ctx}/sys/share/form?id=${share.id}">共享积分<shiro:hasPermission name="sys:share:edit">${not empty share.id?'修改':'新增'}</shiro:hasPermission><shiro:lacksPermission name="sys:share:edit">查看</shiro:lacksPermission></a></a></h5>
                    </div>
