            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
						<form:form id="inputForm" modelAttribute="sysConfig" action="${ctx}/jzmk/sysConfig/save" method="post" class="form-horizontal m-t">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="bookingDays" name="bookingDays" value="${sysConfig.bookingDays }" class="form-control" type="number" aria-required="true" aria-invalid="true" class="error" maxlength="3" >
                                	（分钟）
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="surveyTotal" name="surveyTotal" value="${sysConfig.surveyTotal }" class="form-control" type="number" aria-required="true" aria-invalid="true" class="error" maxlength="3">
                                </div>
                            </div>
                            <div class="form-group">
