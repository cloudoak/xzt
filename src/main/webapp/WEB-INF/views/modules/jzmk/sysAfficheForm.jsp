            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5><a class="text-navy" href="${ctx}/jzmk/sysAffiche/form?id=${sysAffiche.id}">公告${not empty sysAffiche.id?'修改':'添加'}</a></h5>
                    ...
                    <div class="ibox-content">
                        ...
                        <form class="form-horizontal m-t" id="signupForm" action="${ctx}/jzmk/sysAffiche/save" method="post">
