            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5><a class="text-navy" href="${ctx}/sys/org/form?id=${afficheContent.id}&parent.id=${afficheContent.parent.id}">公告<shiro:hasPermission name="sys:afficheContent:edit">${not empty afficheContent.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:afficheContent:edit">查看</shiro:lacksPermission></a></h5>
                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="signupForm" action="${ctx}/jzmk/sysAffiche/org/save" method="post">
                            <input type="hidden" name="id" value="${sysAffiche.id }">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">公告标题：</label>
                                <div class="col-sm-8">
                                   	<input id="afficheTitle" name="afficheTitle" value="${sysAffiche.afficheTitle }" class="form-control" type="text" required="required">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                 	<input id="afficheContent" name="afficheContent" type="hidden" value="">
                                    <%-- <input id="afficheContent" value="${sysAffiche.afficheContent }" name="afficheContent" class="form-control" type="text" aria-required="true" aria-invalid="true" class="error"> --%>
                            ...
                            <%-- <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <form:hidden id="nameImage" path="sysAffiche.headImage" htmlEscape="false" maxlength="255" class="input-xlarge"/>
									<sys:ckfinder input="nameImage" type="images" uploadPath="/jzmk/sysAffiche" selectMultiple="false" maxWidth="100" maxHeight="100"/>
                                </div>
                            </div> --%>
                            <div class="form-group">
                                ...
                                <fieldset>
                                    <div class="radio radio-info radio-inline">
                                        <input type="radio" id="inlineRadio1" value="1" name="firstDisplay" ${sysAffiche.firstDisplay==1?"checked":"" } required="required">
                                        <label for="inlineRadio1">是</label>
                                    </div>
                                    <div class="radio radio-inline">
                                        <input type="radio" id="inlineRadio2" value="0" name="firstDisplay" ${sysAffiche.firstDisplay==0?"checked":"" } required="required">
