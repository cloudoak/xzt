                    ...
                    <div class="ibox-content">
						<form:form id="inputForm" modelAttribute="counselorType" action="${ctx}/ante/counselorType/save" method="post" class="form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<form:input path="typeName" htmlEscape="false" maxlength="20" required="true" class="input-xlarge " readonly="readonly" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-3 control-label">类型描述：</label>
								<div class="col-sm-8">
									<form:textarea path="comment" htmlEscape="false" rows="4" maxlength="255" required="true" class="input-xxlarge " readonly="readonly"/>
								</div>
							</div>
							<div class="form-group">
