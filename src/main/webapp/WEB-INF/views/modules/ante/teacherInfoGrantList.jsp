...
<body class="gray-bg">
        ...
        <div class="ibox float-e-margins">
            <div class="ibox-content">
                <div class="row row-lg">
                    <div class="col-sm-12">
                        <h4 class="example-title">咨询师权限设置: ${counselor.user.name }</h4>
                        <div class="example">
                            ...
                            <div class="form-group">
                                <div class="col-sm-8 col-sm-offset-3">
                                    <button class="btn btn-primary" id="btnSetCounselorGrant">保存</button>&nbsp;
	...
	<script type="text/javascript">
		...
		$(function(){
			...
			//保存角色权限
			$("#btnSetCounselorGrant").click(function(){
				var menuIds="";
				$("input[id^='menu']:checked").each(function(index,chk){
					menuIds+=$(chk).val()+",";
				});
				$.post("${ctx}/ante/teacherInfo/saveMenus",{
					menuIds:menuIds,
					counselorId:'${counselorId}'
				},function(data){
					layer.msg('咨询师权限设置成功！', {icon: 1});
					window.location.href="${ctx}/ante/teacherInfo/list";
				});
			});
