...
<head>
    ...
    <title>${sysConfig.schoolName } 公益活动--我发布的公益活动</title>
	       ...
	       <div class="ibox float-e-margins">
	           <div class="ibox-content">
	               <div class="row row-lg">
	                   <div class="col-sm-12">
	                       <h4 class="example-title">我发布的公益活动列表</h4>
						<div class="example">
	                  			<div class="btn-group " id="exampleTableEventsToolbar" role="group">
	                               <shiro:hasPermission name="ante:publicActivity:edit">
									<a class="J_menuItem" href="${ctx}/ante/publicActivity/form?myActivity=true">
						...
						<form id="searchForm" action="${ctx}/ante/publicActivity/myList" method="post" class="form-inline">
							...
							<div class="form-group">
								<label>所属机构：</label><input id="orgName" name="orgName" class="form-control" type="text" maxlength="11"/>
						...
						<table id="publicActivityMyTable" data-toggle="table" data-query-params="queryParams" data-mobile-responsive="true" data-height="400" data-pagination="true">
							<thead>
								<tr>
									<th align="center" data-checkbox="true" aria-hidden="true"></th>
                                    <th align="center" data-field="id" data-visible="false"></th>
									<th align="center" data-field="title">标题</th>
									<th align="center" data-field="createName">发布人</th>
									<th align="center" data-field="updateDate">发布时间</th>
									<th align="center" data-field="orgName">所属机构</th>
									<th align="center" data-field="activityStatus">活动状态</th>
									<th align="center" data-field="checkStatus">审核状态</th>
									<shiro:hasPermission name="ante:publicActivity:edit"><th align="center">操作</th></shiro:hasPermission>
								</tr>
							</thead>
