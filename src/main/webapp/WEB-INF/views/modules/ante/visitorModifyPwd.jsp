...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/ante/visitorInfo/modifyPwd">修改密码</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="visitorInfo" action="${ctx}/ante/visitorInfo/modifyPwd" method="post" class="form-horizontal">
		<form:hidden path="id"/>
