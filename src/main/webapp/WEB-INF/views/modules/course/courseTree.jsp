...
<head>
	...
	<style type="text/css">
		...
		.ztree li span.button.level0, .ztree li a.dV/zvD/ZAlevel0 {display:none;height:0;}
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var zNodes=[
		            ...
		            {id:'${tpl.id}', pId:'${not empty tpl.parent?tpl.parent.id:0}', name:"${tpl.name}", url:"${ctx}/course/course/?course.courseCatalogParentids=${tpl.parentIds}&course.courseCatalogId=${tpl.id}", target:"courseMainFrame"},
		            </c:forEach>];
			<%--
...
<body>
	<div class="accordion-group">
	    <div class="accordion-heading">
	    	<a class="accordion-toggle">课件分类列表</a>
	    </div>
