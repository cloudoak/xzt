                    ...
                    <div class="ibox-content">
                        <form class="form-horizontal m-t" id="signupForm" method="post">
                            ...
                            <div class="text-center article-title">
                                <h1>
                                   	${sysAffiche.afficheTitle }
                                </h1>
                            </div>
                            <%-- <div class="form-group">
                                <label class="col-sm-3 control-label">内容：</label>
                                <div class="col-sm-8">
                                    <div><lable>${sysAffiche.afficheContent!=""?sysAffiche.afficheContent:"暂无"}</label></div>
                                 	<input id="afficheContent" name="afficheContent" type="hidden" value="${sysAffiche.afficheContent}" >
			                        <div class="summernote"></div>
                                </div>
                            </div> --%>
                            <div class="form-group">
                                <p class="col-sm-offset-1">${sysAffiche.afficheContent!=""?sysAffiche.afficheContent:"暂无"}</p>
                            </div>
                            <%-- <div class="form-group">
