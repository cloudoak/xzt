...
CKEDITOR.lang['zh-cn'] =
{
	...
	common :
	{
		...
		invalidCssLength	: '该字段必须为合式的CSS长度值，包括机构(px, %, in, cm, mm, em, ex, pt 或 pc)',
		invalidHtmlLength	: '该字段必须为合式的HTML长度值，包括机构(px 或 %)',
		invalidInlineStyle	: '内联样式必须为格式是以分号分隔的一个或多个“属性名 : 属性值”',
		cssLengthTooltip	: '该字段必须为合式的CSS长度值，包括机构(px, %, in, cm, mm, em, ex, pt 或 pc)',
