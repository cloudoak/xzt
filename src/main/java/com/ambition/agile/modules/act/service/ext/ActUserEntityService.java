 ...
 */
package com.ambition.agile.modules.act.service.ext;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.ambition.agile.modules.sys.entity.User(Integer.valueOf(user.getId())));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.ambition.agile.modules.sys.entity.User(null, userId)))){
