 ...
 */
package com.ambition.agile.modules.act.web;
...
import com.ambition.agile.modules.act.service.ActTaskService;
...
//		return "modules/act/actTaskForm";
	...
	@ResponseBody
	public String start(Act act, String table, Integer id, Model model) throws Exception {
	 ...
	 * 		vars.keys=flag,pass
	 * 		vars.values=1,true
	 * 		vars.types=S,B  @see com.ambition.agile.modules.act.utils.PropertyType
	 */
