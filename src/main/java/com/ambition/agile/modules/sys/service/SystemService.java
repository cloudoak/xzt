...
public class SystemService extends BaseService implements InitializingBean {
	...
	public User findExistsUserName(User user) {
		return userDao.findExistsUserName(user);
	}
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	@Transactional(readOnly = false)
	public int updateStatus(User user, Integer status) {
		User currentUser = userDao.get(user.getId());
		currentUser.setStatus(status);
		UserUtils.clearCache(user);
		return userDao.updateStatus(currentUser);
	}
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public List<Integer> selectRoleMenu(Role role){
		return roleDao.selectRoleMenu(role.getId());
	}
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public static boolean printKeyLoadMessage(){
		...
		sb.append("\r\n======================================================================\r\n");
		sb.append("\r\n    欢迎使用 "+Global.getConfig("productName")+"  - Powered By harry \r\n");
		sb.append("\r\n======================================================================\r\n");
	...
	public User getOfficeAndUserType(User user) {
		return UserUtils.getOfficeAndUserType(user);
	}

	public List<User> selectUserByLoginName(String loginName) {
		return UserUtils.selectUserByLoginName(loginName);
	}
	 ...
	 */
	@Transactional
	public Integer updateRoleMenu(Integer roleId,Integer menuId){
	...
	public List<User> findUserByOrgIdAndUserType(User user) {
		return userDao.findUserByOrgIdAndUserType(user);
	}
