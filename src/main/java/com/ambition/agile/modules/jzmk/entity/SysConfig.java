...
public class SysConfig extends DataEntity<SysConfig> {
	...
	private String zgwjIntegral;		// 资格文件
	private Integer kjscIntegral;		// 课件上传
	private Long zyIntegral;		// 资源
	...
	@Length(min=0, max=11, message="资格文件长度必须介于 0 和 11 之间")
	public String getZgwjIntegral() {
		return zgwjIntegral;
	}

	public void setZgwjIntegral(String zgwjIntegral) {
	...
	public Long getZyIntegral() {
		return zyIntegral;
	}

	public void setZyIntegral(Long zyIntegral) {
