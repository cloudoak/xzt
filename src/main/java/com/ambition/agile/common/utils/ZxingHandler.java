...
public class ZxingHandler {
	...
	public static void main(String[] args) {
		...
		// 二维码
		String imgPath2 = "target\\harry.png";
		String contents2 = "Hello Gem, welcome to harry!"
				+ "\nBlog [ http://harry.iteye.com ]"
				+ "\nEMail [ dragonhanqingtao@163.com ]";
		int width2 = 300, height2 = 300;

		ZxingHandler.encode2(contents2, width2, height2, imgPath2);
		System.out.println("finished harry encode.");

		String decodeContent2 = ZxingHandler.decode2(imgPath2);
		System.out.println("解码内容如下：" + decodeContent2);
		System.out.println("finished harry decode.");
